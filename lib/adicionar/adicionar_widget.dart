...
class _AdicionarWidgetState extends State<AdicionarWidget> {
  ...
  void initState() {
    ...
    _model.idController ??= TextEditingController(text: widget.id?.toString());
    _model.idFocusNode ??= FocusNode();
    _model.yourNameController ??= TextEditingController(text: widget.nome);
